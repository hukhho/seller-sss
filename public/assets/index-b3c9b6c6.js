...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xr=Dr,Br=Xr.NEGATIVE_INFINITY,cr=Br;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ha=$a,da=ya,ga=ma,F;ha()?F=da:F=ga;var Sa=F;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ra=br;function Ca(r){return Ra.call(r)}var Da=Ca;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Za=Ga,ka=Da,re=Ya,L;Za()?L=re:L=ka;var S=L;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Ae(){throw new Error("not implemented")}var me=Ae;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var he=ye,de=be,ge=me,M;he()?M=de:M=ge;var V=M;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ce=We,De=Ge,Xe=Re,W;Ce()?W=De:W=Xe;var x=W;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var gt=bt,U=mt,er=dt;function St(){var r,a;if(typeof er!="function")return!1;try{a=[1,3.14,-3.14,U+1,U+2],a=new er(a),r=gt(a)&&a[0]===1&&a[1]===3&&a[2]===U-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var wt=St;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xt=J,mr,j,R;Xt===!0?(j=1,R=0):(j=0,R=1);mr={HIGH:j,LOW:R};var Bt=mr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var vn=J,Ir,D,X;vn===!0?(D=1,X=0):(D=0,X=1);Ir={HIGH:D,LOW:X};var sn=Ir;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var mn=oa,hn=fa,dn=wr,gn=Nr,Sn=Pr,E=[0,0];function wn(r,a){var e,t;return dn.assign(r,E,1,0),e=E[0],e&=hn,t=gn(a),t&=mn,e|=t,Sn(e,E[1])}var On=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Cn=Tr;function Dn(r){return Cn(r,[0,0],1,0)}var Xn=Dn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Bn=_r,Fr=Xn,Vn=Tr;Bn(Fr,"assign",Vn);var xn=Fr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
