...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xt=J,Ar,j,R;Xt===!0?(j=1,R=0):(j=0,R=1);Ar={HIGH:j,LOW:R};var Bt=Ar;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
